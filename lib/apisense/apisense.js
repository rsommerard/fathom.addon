...
const sdkKey = 'bea507b9-564a-49a5-9378-e6b2e23b3179'
const slug = 'QzNnWx9gRlF3dqPqzOBN'
...
const _execute = function (script, collectUrl, reportUrl, scriptVersion, dataToken) {
  ...
  const scriptToExecute = script + '//# sourceURL=crop-script.js'

  timers.setTimeout(function() {
    try {
      new Function('require', scriptToExecute)(_require)
    } catch (e) {
