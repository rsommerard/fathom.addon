...
ss.storage['devmode'] = ((system.staticArgs && system.staticArgs.dev) || 
						  self.version.indexOf('-dev')>0 || 
						  self.version.indexOf('-beta')>0);
...
const apilist = [upload, systemapi, socketapi, protoapi, baselineapi, toolsapi];
...
exports.setup = function(reason) {
	...
	apisense.doBaselineMeasurements();
};
